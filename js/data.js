...
export const RIVALS = [
  ...
  "FC Meteora",
  "Inter de Urano",
  "Solteros Intergalácticos",
  "Racing de Cohete",
  "Trinaxidos & Cia",
  "Los mejores Pux'hleas",
];
...
export const playersPool = [
  {
    ...
    tier: 2,
    credits: 3,
    name: "Blirb de la Nebulosa Botellines",
    blurb:
      "No te garantiza que se presente sobrio a los partídos, el rey de la fiesta del sistema",
    quirks: ["resacoso"],
    stats: {
      technique: 3,
      speed: 2,
  ...
  },
  {
    ...
    credits: 2,
    name: "Piti El manos",
    blurb: "Más de dos, es trampa. Le echaron de su trabajo por acosador.",
    quirks: ["puños"],
    stats: {
      technique: 2,
      speed: 3,
  ...
  },
  {
    ...
    tier: 3,
    credits: 4,
    name: "Pino 'Gato' Verdejo",
    blurb: "Reflejos felinos... porque es un gato antropomórfico.",
    quirks: ["felino"],
    stats: {
      technique: 4,
      speed: 4,
  ...
  },
  {
    ...
    tier: 2,
    credits: 2,
    name: "Puerta, la Puerta",
    blurb: "Si, se llama Puerta. Cosas de su planeta.",
    quirks: ["condicional"],
    stats: {
      technique: 2,
      speed: 4,
  ...
  },
  {
    ...
    credits: 1,
    name: "Antonio",
    blurb: "El único terrestre. Antonio.",
    quirks: ["silencioso"],
    stats: {
      technique: 3,
      speed: 3,
  ...
  },
  {
    ...
    credits: 2,
    name: "Chabba el Chad",
    blurb: "164 kilos de pura defensa, liga con todas.",
    quirks: ["barrendero"],
    stats: {
      technique: 3,
      speed: 3,
  ...
  },
  {
    ...
    credits: 4,
    name: "Rulo-01",
    blurb: "Robot ladrón, que cree que son de su condición.",
    quirks: ["ladron"],
    stats: {
      technique: 4,
      speed: 5,
  ...
  },
  {
    ...
    tier: 2,
    credits: 2,
    name: "Geranio Palontis",
    blurb: "Más años que el andar.",
    quirks: ["anciano"],
    stats: {
      technique: 3,
      speed: 5,
  ...
  },
  {
    ...
    tier: 2,
    credits: 3,
    name: "Chato de la Nebulosa del Cangrejo",
  ...
  },
  {
    ...
    tier: 3,
    credits: 4,
    name: "Rafa de la estación Gamma",
  ...
  },
  {
    ...
    credits: 2,
    name: "2134-X",
    blurb: "Ente abstracto. No sabe ni dónde está parao.",
    quirks: ["no_look"],
    stats: {
      technique: 6,
      speed: 5,
  ...
  },
  {
    ...
    tier: 2,
    credits: 2,
    name: "Klin el Chiquito",
    blurb: "20cm de pura bestia",
    quirks: ["mosca"],
    stats: {
      technique: 5,
      speed: 5,
  ...
  },
  {
    ...
    tier: 1,
    credits: 1,
    name: "Azorín el Florete",
    blurb:
      "Lo que le falta de visión lo compensa con corazón. Le encantan las flores.",
    quirks: ["pausado"],
    stats: {
      technique: 4,
      speed: 3,
  ...
  },
  {
    ...
    tier: 2,
    credits: 3,
    name: "Chispas Xterzztst",
    blurb:
      "Pura electricidad tomada consciencia. Cuidado no te acerques sin un buen gorro de aluminio.",
    quirks: ["chisposo"],
    stats: {
      technique: 6,
      speed: 6,
  ...
  },
  {
    ...
    tier: 2,
    credits: 2,
    name: "Tiki de Ertrades",
    blurb: "Ágil noble caído en desgracia. Hermano de Taka.",
    quirks: ["tiki"],
    stats: {
      technique: 6,
      speed: 4,
  ...
  },
  {
    ...
    tier: 2,
    credits: 2,
    name: "Taka de Ertrades",
    blurb: "Ágil noble caído en desgracia. Hermano de Tiki.",
    quirks: ["asegurador"],
    stats: {
      technique: 5,
      speed: 5,
  ...
  },
  {
    ...
    credits: 4,
    name: "María Equasha",
    blurb: "Maneja el balón como si estuviese deslizazndose por el hielo.",
    quirks: ["filigranas"],
    stats: {
      technique: 8,
      speed: 5,
  ...
  },
  {
    ...
    tier: 2,
    credits: 3,
    name: "Linlin Rodrímez",
    blurb: "Corre que se las pela, y viceversa.",
    quirks: ["rachas"],
    stats: {
      technique: 6,
      speed: 6,
  ...
  },
  {
    ...
    credits: 3,
    name: "John Calamaro",
    blurb: "El calamar humanoide más rápido del oeste.",
    quirks: ["cañon"],
    stats: {
      technique: 5,
      speed: 5,
  ...
  },
  {
    ...
    tier: 3,
    credits: 4,
    name: "Bitsy 'la ratilla'",
    blurb: "Rata antropomorfa. Huele el gol como las ratas al queso.",
    quirks: ["olfato"],
    stats: {
      technique: 7,
      speed: 7,
  ...
  },
  {
    ...
    tier: 1,
    credits: 1,
    name: "Eduardo del Arco Exterior",
  ...
  },
  {
    ...
    tier: 2,
    credits: 3,
    name: "Crisitano del Sistema CR69",
