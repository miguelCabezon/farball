...
function renderClubSummary(){
  ...
  root.querySelector("#btn-jugar-jornada").onclick = ()=>{
    // Partidos de la jornada (incluye el tuyo)
    ...
    // Construye equipos (tu partido con motor real)
    ...
    // Resto de partidos IA vs IA (basados en power)
    simulateAIRound(career.league, matches);

    // Avanza jornada y refresca UI
